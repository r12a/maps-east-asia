...
$message = '';
		...
		echo 'svgtext length '.strlen($svgtext)."<br/>";
		$newsvgtext = str_replace("../../r12a.github.io/maps/eastasia/relief_map.jpg","../relief_map.jpg",$svgtext);
		$newsvgtext = str_replace("'MyriadPro-Regular'","'Myriad Pro',Helvetica,Arial,sans-serif",$newsvgtext);
